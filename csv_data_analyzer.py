"""
CSV Data Analyzer — a small, honest tool for understanding messy data.

Usage:
    python csv_data_analyzer.py --file data.csv --column SomeColumn
    python csv_data_analyzer.py --file data.csv  # analyze first numeric column

Outputs:
    cleaned_data.csv        ← de-duplicated input
    column_plot.png         ← smart plot (histogram or bar chart)
